    ...
    <div>
      ...
      <main className="min-h-100vh md:mx-[20vw] ">
        <div className="flex place-content-around content-center px-4 pt-5 pb-2">
          ...
          >
            <a className="mt-5 inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
              Enter
            </a>
          </Link>
        </div>
        <div className="flex-col flex items-center justify-center">
          ...
          <div className="w-100vw bg-white py-5">
            <div className="px-4 pb-5 md:mx-[20vw]">
              ...
              <p className="mt-4 max-w-2xl text-start text-xl text-gray-500">
                Communion is an operator- and worker-owned staffing network for
                retail, restaurants, and hospitality.
                <br />
                <br />
                When you use Communion, you&apos;re awarded points that entitle
                you to a portion of revenue generated by the platform.
                <br />
                <br />
            ...
            <div className="w-100vw bg-gray-800">
              <div className="mx-auto max-w-7xl py-8 px-4 sm:py-12 sm:px-6 lg:flex lg:justify-center lg:px-8">
          ...
          {/** How it works */}
          <div className="w-100vw bg-indigo-700">
            <div className="max-w-4xl px-4 py-6 sm:px-6 md:mx-[20vw] lg:px-8">
              <h2 className="text-3xl font-bold tracking-tight text-white">
                How It Works
              </h2>
              <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
